    ...
    return (
        <footer className="flex flex-col items-center bg-gray-400 text-black text-center">
            <div className="mt-2 mb-1 text-sm sm:text-base">
                <Link href="/" className="inline-block p-1 rounded-md border-solid border-2 border-gray-700 hover:text-gray-700 hover:bg-gray-200">
                    {t('homepage')}
                </Link>
                <Link href="/about" className="inline-block ml-1 sm:ml-2 p-1 rounded-md border-solid border-2 border-gray-700 hover:text-gray-700 hover:bg-gray-200">
                    {t('about')}
                </Link>
                <a
                ...
                <Link href="/terms" className="inline-block ml-1 sm:ml-2 p-1 rounded-md border-solid border-2 border-gray-700 hover:text-gray-700 hover:bg-gray-200">
                    {t('terms')}
                </Link>
            </div>
            ...
            <div className="absolute right-0 pt-16 pr-2 text-gray-600 focus-within:text-gray-400">
                <select
                    name="language"
                    className="py-1 text-xs sm:text-base bg-gray-100 rounded-md focus:outline-none focus:bg-gray-200 focus:text-gray-900"
