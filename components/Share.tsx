...
const copyUrl = (url: string) => {
    if (!navigator.clipboard) {
        ...
        (document.getElementById('copyId') as HTMLInputElement).value = url;
        copyInput.select();
...
export default function Share({ lang, url, title }: ShareProps) {
    ...
    return (
        ...
        >
            ...
            <div
                className={`${!share ? 'hidden' : 'block'
                    } origin-top-right absolute right-0 w-56 rounded-md shadow-lg text-center z-10`}
            >
                <div
